...
export {}
declare global {
  const ANGGOTA_STATUS: typeof import('../../app/utils/constants').ANGGOTA_STATUS
  const API_ENDPOINTS: typeof import('../../app/utils/constants').API_ENDPOINTS
  const APP_DESCRIPTION: typeof import('../../app/utils/constants').APP_DESCRIPTION
  const APP_NAME: typeof import('../../app/utils/constants').APP_NAME
  const APP_VERSION: typeof import('../../app/utils/constants').APP_VERSION
  ...
  const ROUTES: typeof import('../../app/utils/constants').ROUTES
  const RoleConfig: typeof import('../../app/utils/roles').RoleConfig
  const RolePermissions: typeof import('../../app/utils/roles').RolePermissions
  const STORAGE_KEYS: typeof import('../../app/utils/constants').STORAGE_KEYS
  const SuperadminMenu: typeof import('../../app/utils/menus').SuperadminMenu
  const TenantRegistrationService: typeof import('../../app/services/tenant-registration.service').TenantRegistrationService
  const USER_ROLES: typeof import('../../app/utils/constants').USER_ROLES
  const VALIDATION: typeof import('../../app/utils/constants').VALIDATION
  ...
  const capitalize: typeof import('../../app/utils/formatters').capitalize
  ...
  const formatCurrency: typeof import('../../app/utils/formatters').formatCurrency
  const formatDate: typeof import('../../app/utils/formatters').formatDate
  const formatDateTime: typeof import('../../app/utils/formatters').formatDateTime
  const formatFileSize: typeof import('../../app/utils/formatters').formatFileSize
  const formatNIK: typeof import('../../app/utils/formatters').formatNIK
  const formatNumber: typeof import('../../app/utils/formatters').formatNumber
  const formatPhone: typeof import('../../app/utils/formatters').formatPhone
  ...
  const getInitials: typeof import('../../app/utils/formatters').getInitials
  const getMenuByRole: typeof import('../../app/utils/menus').getMenuByRole
  const getRolePermissions: typeof import('../../app/utils/roles').getRolePermissions
  ...
  const hasPermission: typeof import('../../app/utils/roles').hasPermission
  ...
  const isInRange: typeof import('../../app/utils/validators').isInRange
  ...
  const isRequired: typeof import('../../app/utils/validators').isRequired
  const isShallow: typeof import('../../node_modules/vue').isShallow
  const isValidEmail: typeof import('../../app/utils/validators').isValidEmail
  const isValidNIK: typeof import('../../app/utils/validators').isValidNIK
  const isValidPassword: typeof import('../../app/utils/validators').isValidPassword
  const isValidPhone: typeof import('../../app/utils/validators').isValidPhone
  ...
  const truncate: typeof import('../../app/utils/formatters').truncate
...
declare global {
  ...
  // @ts-ignore
  export type { ApiService } from '../../app/services/api.service'
  import('../../app/services/api.service')
  // @ts-ignore
  export type { AuthService, LoginCredentials, LoginResponse, JwtPayload, UserProfile } from '../../app/services/auth.service'
  import('../../app/services/auth.service')
  // @ts-ignore
  export type { TenantRegistrationService } from '../../app/services/tenant-registration.service'
  import('../../app/services/tenant-registration.service')
}
// for vue template auto import
import { UnwrapRef } from 'vue'
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly ANGGOTA_STATUS: UnwrapRef<typeof import('../../app/utils/constants')['ANGGOTA_STATUS']>
    readonly API_ENDPOINTS: UnwrapRef<typeof import('../../app/utils/constants')['API_ENDPOINTS']>
    readonly APP_DESCRIPTION: UnwrapRef<typeof import('../../app/utils/constants')['APP_DESCRIPTION']>
    readonly APP_NAME: UnwrapRef<typeof import('../../app/utils/constants')['APP_NAME']>
    readonly APP_VERSION: UnwrapRef<typeof import('../../app/utils/constants')['APP_VERSION']>
    ...
    readonly ROUTES: UnwrapRef<typeof import('../../app/utils/constants')['ROUTES']>
    readonly RoleConfig: UnwrapRef<typeof import('../../app/utils/roles')['RoleConfig']>
    readonly RolePermissions: UnwrapRef<typeof import('../../app/utils/roles')['RolePermissions']>
    readonly STORAGE_KEYS: UnwrapRef<typeof import('../../app/utils/constants')['STORAGE_KEYS']>
    readonly SuperadminMenu: UnwrapRef<typeof import('../../app/utils/menus')['SuperadminMenu']>
    readonly TenantRegistrationService: UnwrapRef<typeof import('../../app/services/tenant-registration.service')['TenantRegistrationService']>
    readonly USER_ROLES: UnwrapRef<typeof import('../../app/utils/constants')['USER_ROLES']>
    readonly VALIDATION: UnwrapRef<typeof import('../../app/utils/constants')['VALIDATION']>
    ...
    readonly capitalize: UnwrapRef<typeof import('../../app/utils/formatters')['capitalize']>
    ...
    readonly formatCurrency: UnwrapRef<typeof import('../../app/utils/formatters')['formatCurrency']>
    readonly formatDate: UnwrapRef<typeof import('../../app/utils/formatters')['formatDate']>
    readonly formatDateTime: UnwrapRef<typeof import('../../app/utils/formatters')['formatDateTime']>
    readonly formatFileSize: UnwrapRef<typeof import('../../app/utils/formatters')['formatFileSize']>
    readonly formatNIK: UnwrapRef<typeof import('../../app/utils/formatters')['formatNIK']>
    readonly formatNumber: UnwrapRef<typeof import('../../app/utils/formatters')['formatNumber']>
    readonly formatPhone: UnwrapRef<typeof import('../../app/utils/formatters')['formatPhone']>
    ...
    readonly getInitials: UnwrapRef<typeof import('../../app/utils/formatters')['getInitials']>
    readonly getMenuByRole: UnwrapRef<typeof import('../../app/utils/menus')['getMenuByRole']>
    readonly getRolePermissions: UnwrapRef<typeof import('../../app/utils/roles')['getRolePermissions']>
    ...
    readonly hasPermission: UnwrapRef<typeof import('../../app/utils/roles')['hasPermission']>
    ...
    readonly isInRange: UnwrapRef<typeof import('../../app/utils/validators')['isInRange']>
    ...
    readonly isRequired: UnwrapRef<typeof import('../../app/utils/validators')['isRequired']>
    readonly isShallow: UnwrapRef<typeof import('../../node_modules/vue')['isShallow']>
    readonly isValidEmail: UnwrapRef<typeof import('../../app/utils/validators')['isValidEmail']>
    readonly isValidNIK: UnwrapRef<typeof import('../../app/utils/validators')['isValidNIK']>
    readonly isValidPassword: UnwrapRef<typeof import('../../app/utils/validators')['isValidPassword']>
    readonly isValidPhone: UnwrapRef<typeof import('../../app/utils/validators')['isValidPhone']>
    ...
    readonly truncate: UnwrapRef<typeof import('../../app/utils/formatters')['truncate']>
