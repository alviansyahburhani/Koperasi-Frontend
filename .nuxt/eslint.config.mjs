...
export const options = resolveOptions({
  ...
  dirs: {
    pages: ["app/pages"],
    composables: ["app/composables", "app/utils", "app/stores", "app/services"],
