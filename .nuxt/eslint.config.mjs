...
import {
  ...
  defineFlatConfigs,
  resolveOptions,
} from '../node_modules/@nuxt/eslint/node_modules/@nuxt/eslint-config/dist/flat.mjs'
...
export function withNuxt(...customs) {
  return configs
    ...
    .append(...customs)
    .onResolved((configs) =>
      typegen(configs, { dtsPath: r('./eslint-typegen.d.ts'), augmentFlatConfigUtils: true })
    )
}
