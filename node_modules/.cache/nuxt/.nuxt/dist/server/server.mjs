...
import { $fetch as $fetch$1 } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/h3/dist/index.mjs";
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/ufo/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu, defuFn } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { klona } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/klona/dist/index.mjs";
import colors from "tailwindcss/colors";
import { useHead as useHead$1, headSymbol } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/@unhead/vue/dist/index.mjs";
...
import { debounce } from "/home/runner/work/Koperasi-Frontend/Koperasi-Frontend/node_modules/perfect-debounce/dist/index.mjs";
...
const _routes = [
  {
    name: "fitur",
    path: "/fitur",
    component: () => import("./_nuxt/fitur-rZr9f0EH.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-NN6SRWOW.js")
  },
  {
    name: "tentang",
    path: "/tentang",
    component: () => import("./_nuxt/tentang-D7FZy4Ms.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "guest" } },
    component: () => import("./_nuxt/login-B7VXSEIq.js")
  },
  {
    name: "superadmin",
    path: "/superadmin",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-70choQDP.js")
  },
  {
    name: "auth-lupa-password",
    path: "/auth/lupa-password",
    component: () => import("./_nuxt/lupa-password-CSGcbjAd.js")
  },
  {
    name: "auth-reset-password",
    path: "/auth/reset-password",
    component: () => import("./_nuxt/reset-password-DIjcMieJ.js")
  },
  {
    name: "pendaftaran-anggota",
    path: "/pendaftaran/anggota",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/anggota-BJ-dw1FE.js")
  },
  {
    name: "pendaftaran-koperasi",
    path: "/pendaftaran/koperasi",
    component: () => import("./_nuxt/koperasi-CuCjQpYu.js")
  },
  {
    name: "superadmin-koperasi",
    path: "/superadmin/koperasi",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/index-DtAgMhfK.js")
  },
  {
    name: "superadmin-permohonan",
    path: "/superadmin/permohonan",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-xxKmPMQM.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-gMinw5d6.js"),
  guest: () => import("./_nuxt/guest-xZmd-C_z.js"),
  permission: () => import("./_nuxt/permission-DOelei7u.js"),
  role: () => import("./_nuxt/role-DbFbkGkR.js")
};
...
const layouts = {
  ...
  auth: defineAsyncComponent(() => import("./_nuxt/auth-CMlCp_62.js").then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import("./_nuxt/dashboard-BbYUhsI-.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-DJBgSPs_.js").then((m) => m.default || m)),
  superadmin: defineAsyncComponent(() => import("./_nuxt/superadmin-dJKbhOBK.js").then((m) => m.default || m))
};
