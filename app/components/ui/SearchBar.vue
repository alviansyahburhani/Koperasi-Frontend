...
<template>
  <div class="relative max-w-lg mx-auto lg:mx-0 group">
    ...
    <div
      class="absolute inset-0 bg-gradient-to-r from-red-400 to-red-600 rounded-full blur opacity-20 group-hover:opacity-40 transition duration-500"
    />

    <!-- Search input container -->
    <div
      class="relative flex items-center bg-white border border-slate-200 rounded-full p-2 shadow-lg focus-within:ring-2 focus-within:ring-red-500 transition-all"
    >
